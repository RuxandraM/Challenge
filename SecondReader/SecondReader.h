...
#define READER_OUTPUT_NAME	"SecondReaderOut"
...
static FileLimits GetFileLimits(u_int uTotalNumSegments)
{
	...
	xResult.m_uNumFiles = uTotalNumSegments / READER_NUM_SEGMENTS_FILE;
	...
	if (xResult.m_uNumFiles > READER_MAX_NUM_FILES)
	{
		...
		xResult.m_uNumSegmentsPerFile = uTotalNumSegments / READER_MAX_NUM_FILES;

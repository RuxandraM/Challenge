...
#include "ReaderTransform.h"
#include <vector>


static int g_iProcessIndex = 4; //TODO: this is hardcoded; it should be sent at creation
...
int main()
{
	...
	printf("Reader Transform done. Waiting key press... \n");
	WaitKeyPress(2);
